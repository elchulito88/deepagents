...
def create_model():
    ...
    if ollama_base_url:
        ...
        console.print("[yellow]⚠️  Warning: Ollama models have limited tool-calling reliability.[/yellow]")
        console.print("[yellow]   For best results, use OpenAI or Anthropic models.[/yellow]")
        return ChatOllama(
            model=model_name,
    ...
    console.print("\nFor Ollama, also set:")
    console.print("  - OLLAMA_MODEL       (optional, defaults to llama3.1)")
    console.print("\nExample:")
    console.print("  export OPENAI_API_KEY=your_api_key_here")
    console.print("  # or for Ollama (limited tool support):")
    console.print("  export OLLAMA_BASE_URL=http://localhost:11434")
    console.print("  export OLLAMA_MODEL=llama3.1:8b")
